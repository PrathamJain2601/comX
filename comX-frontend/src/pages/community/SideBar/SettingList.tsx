      ...
      <div className="w-60 bg-white flex flex-col border-r">
        ...
        <ScrollArea className="flex-grow">
          {groups.map((category: any) => (
            <div key={category.id} className="m-2 mx-6">
              <button
                className={`flex items-center w-full px-4 py-2 mb-2 text-sm font-medium text-left rounded-lg transition-all duration-300 ease-in-out transform ${
